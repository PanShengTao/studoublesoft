...
public class MyDragListView extends ListView {
	...
	private int mItemHeightNormal = 20;
	private int mItemHeightExpanded = 80;
	private int mItemHeightHalf = 40;
	public boolean allowToDrag = false;
	...
	public MyDragListView(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray a = context.obtainStyledAttributes(attrs,
					doublesoft.android.stu.R.styleable.DragListView);
			mItemHeightNormal = a.getDimensionPixelSize(
					doublesoft.android.stu.R.styleable.DragListView_dragCellHeight, mItemHeightNormal);
		...
		if (allowToDrag) {
							...
							new SimpleOnGestureListener() {
								...
								public boolean onFling(MotionEvent e1,
									...
									if (mDragView != null) {
										...
										// flinging while dragging should have
										// no
										// effect
										return true;
									}
			...
			if (mDragListener != null || mDropListener != null) {
				...
				case MotionEvent.ACTION_DOWN:
					...
					View dragger = item.findViewById(doublesoft.android.stu.R.id.CellTitle);// ..........................
					Rect r = mTempRect;
