...
public class MyRadioGroup extends LinearLayout {
	 ...
	 * parameter. Using -1 as the selection identifier clears the selection; such an
	 * operation is equivalent to invoking {@link #clearCheck()}.
	 * </p>
	 *
	 * @param id
	 ...
	 * group is selected and {@link #getCheckedRadioButtonId()} returns null.
	 * </p>
	 *
	 * @see #check(int)
	 * @see #getCheckedRadioButtonId()
	 ...
	 * <p/>
	 * <p>
	 * See {@link LinearLayout Attributes} for a list of all child view attributes
	...
	public static class LayoutParams extends LinearLayout.LayoutParams {
		 ...
		 * height to {@link android.view.ViewGroup.LayoutParams#WRAP_CONTENT} when not
