...
public class LoadingView extends RelativeLayout {
	...
	public void setText(String text) {
		TextView loadingViewText = (TextView) this
				.findViewById(doublesoft.android.stu.R.id.LoadingViewText);
		loadingViewText.setText(text);
	}

	// 开始动画
	public void startAnimation() {
		View loadingViewArc = this.findViewById(doublesoft.android.stu.R.id.LoadingViewArc);
		if (!isStarting) {
	...
	public void stopAnimation() {
		if (isStarting) {
			...
			final View loadingViewArc = this
					.findViewById(doublesoft.android.stu.R.id.LoadingViewArc);
