...
public class PullRefreshView extends LinearLayout {
    ...
    private void init() {
        ...
        // 刷新视图顶端的的view
        refreshView = LayoutInflater.from(mContext).inflate(doublesoft.android.stu.R.layout.public_refresh_top_item, null);
        // 指示器view
        refreshIndicatorView = (ImageView) refreshView.findViewById(doublesoft.android.stu.R.id.RefreshIndicator);
        refresh_arrow_up = doublesoft.android.stu.R.drawable.public_refresh_arrow_up;
        refresh_arrow_down = doublesoft.android.stu.R.drawable.public_refresh_arrow_down;

        // 刷新bar
        bar = (ProgressBar) refreshView.findViewById(doublesoft.android.stu.R.id.RefreshProgress);
        // 下拉显示text
        downTextView = (TextView) refreshView.findViewById(doublesoft.android.stu.R.id.RefreshHint);
        // 下来显示时间
        timeTextView = (TextView) refreshView.findViewById(doublesoft.android.stu.R.id.RefreshTime);
        LayoutParams lp = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
                -refreshTargetTop);
    ...
    public void setRefreshThemeWhite() {
        setRefreshThemeWhite(mContext.getResources().getColor(doublesoft.android.stu.R.color.navigationBarBG));
    }

    public void setRefreshThemeWhite(@ColorInt int bgColor) {
        refreshView.setBackgroundColor(bgColor);
        downTextView.setTextColor(mContext.getResources().getColor(doublesoft.android.stu.R.color.whiteColor80));
        timeTextView.setTextColor(mContext.getResources().getColor(doublesoft.android.stu.R.color.whiteColor40));
        refresh_arrow_up = doublesoft.android.stu.R.drawable.public_refresh_arrow_up_white;
        refresh_arrow_down = doublesoft.android.stu.R.drawable.public_refresh_arrow_down_white;
    }
