package doublesoft.android.stu.titlepopup;
...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height) {
        ...
        setContentView(LayoutInflater.from(mContext).inflate(
                R.layout.public_titlepopup, null));
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = LayoutInflater.from(mContext).inflate(
                            R.layout.public_titlepopup_item, parent, false);
                }
                TextView textView = ViewHolder.get(convertView, R.id.ItemTextView);
