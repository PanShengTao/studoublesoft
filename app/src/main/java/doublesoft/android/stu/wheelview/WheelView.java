...
package doublesoft.android.stu.wheelview;

import doublesoft.android.stu.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    /*
     * / Modified by wulianghuan 2014-11-25 private int[] SHADOWS_COLORS = new int[]
    ...
    // Wheel drawables
    private int wheelBackground = doublesoft.android.stu.R.drawable.wheel_bg;
    private int wheelForeground = doublesoft.android.stu.R.drawable.wheel_val;
    ...
    /**
     * Sets view adapter. Usually new adapters contain different views, so it needs
     * to rebuild view by calling measure().
     *
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // int offset = 60;
        /*
         * / Remarked by wulianghuan 2014-11-27 使用自己的画线，而不是描边 Rect rect = new Rect(left,
         * top, right, bottom) centerDrawable.setBounds(bounds)
